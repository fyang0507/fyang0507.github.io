 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function o(vt,bt){var kt=vt.length;vt.push(bt);e:for(;0<kt;){var St=kt-1>>>1,Ct=vt[St];if(0<c(Ct,bt))vt[St]=bt,vt[kt]=Ct,kt=St;else break e}}function s(vt){return vt.length===0?null:vt[0]}function a(vt){if(vt.length===0)return null;var bt=vt[0],kt=vt.pop();if(kt!==bt){vt[0]=kt;e:for(var St=0,Ct=vt.length,Vt=Ct>>>1;St<Vt;){var Mt=2*(St+1)-1,Ht=vt[Mt],Dt=Mt+1,$t=vt[Dt];if(0>c(Ht,kt))Dt<Ct&&0>c($t,Ht)?(vt[St]=$t,vt[Dt]=kt,St=Dt):(vt[St]=Ht,vt[Mt]=kt,St=Mt);else if(Dt<Ct&&0>c($t,kt))vt[St]=$t,vt[Dt]=kt,St=Dt;else break e}}return bt}function c(vt,bt){var kt=vt.sortIndex-bt.sortIndex;return kt!==0?kt:vt.id-bt.id}if(typeof performance=="object"&&typeof performance.now=="function"){var h=performance;e.unstable_now=function(){return h.now()}}else{var d=Date,g=d.now();e.unstable_now=function(){return d.now()-g}}var b=[],_=[],$=1,et=null,tt=3,it=!1,at=!1,ut=!1,ct=typeof setTimeout=="function"?setTimeout:null,rt=typeof clearTimeout=="function"?clearTimeout:null,ot=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function lt(vt){for(var bt=s(_);bt!==null;){if(bt.callback===null)a(_);else if(bt.startTime<=vt)a(_),bt.sortIndex=bt.expirationTime,o(b,bt);else break;bt=s(_)}}function dt(vt){if(ut=!1,lt(vt),!at)if(s(b)!==null)at=!0,Ut(ft);else{var bt=s(_);bt!==null&&Pt(dt,bt.startTime-vt)}}function ft(vt,bt){at=!1,ut&&(ut=!1,rt(yt),yt=-1),it=!0;var kt=tt;try{for(lt(bt),et=s(b);et!==null&&(!(et.expirationTime>bt)||vt&&!Lt());){var St=et.callback;if(typeof St=="function"){et.callback=null,tt=et.priorityLevel;var Ct=St(et.expirationTime<=bt);bt=e.unstable_now(),typeof Ct=="function"?et.callback=Ct:et===s(b)&&a(b),lt(bt)}else a(b);et=s(b)}if(et!==null)var Vt=!0;else{var Mt=s(_);Mt!==null&&Pt(dt,Mt.startTime-bt),Vt=!1}return Vt}finally{et=null,tt=kt,it=!1}}var gt=!1,wt=null,yt=-1,Et=5,xt=-1;function Lt(){return!(e.unstable_now()-xt<Et)}function Nt(){if(wt!==null){var vt=e.unstable_now();xt=vt;var bt=!0;try{bt=wt(!0,vt)}finally{bt?Ot():(gt=!1,wt=null)}}else gt=!1}var Ot;if(typeof ot=="function")Ot=function(){ot(Nt)};else if(typeof MessageChannel<"u"){var zt=new MessageChannel,Yt=zt.port2;zt.port1.onmessage=Nt,Ot=function(){Yt.postMessage(null)}}else Ot=function(){ct(Nt,0)};function Ut(vt){wt=vt,gt||(gt=!0,Ot())}function Pt(vt,bt){yt=ct(function(){vt(e.unstable_now())},bt)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(vt){vt.callback=null},e.unstable_continueExecution=function(){at||it||(at=!0,Ut(ft))},e.unstable_forceFrameRate=function(vt){0>vt||125<vt?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Et=0<vt?Math.floor(1e3/vt):5},e.unstable_getCurrentPriorityLevel=function(){return tt},e.unstable_getFirstCallbackNode=function(){return s(b)},e.unstable_next=function(vt){switch(tt){case 1:case 2:case 3:var bt=3;break;default:bt=tt}var kt=tt;tt=bt;try{return vt()}finally{tt=kt}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(vt,bt){switch(vt){case 1:case 2:case 3:case 4:case 5:break;default:vt=3}var kt=tt;tt=vt;try{return bt()}finally{tt=kt}},e.unstable_scheduleCallback=function(vt,bt,kt){var St=e.unstable_now();switch(typeof kt=="object"&&kt!==null?(kt=kt.delay,kt=typeof kt=="number"&&0<kt?St+kt:St):kt=St,vt){case 1:var Ct=-1;break;case 2:Ct=250;break;case 5:Ct=1073741823;break;case 4:Ct=1e4;break;default:Ct=5e3}return Ct=kt+Ct,vt={id:$++,callback:bt,priorityLevel:vt,startTime:kt,expirationTime:Ct,sortIndex:-1},kt>St?(vt.sortIndex=kt,o(_,vt),s(b)===null&&vt===s(_)&&(ut?(rt(yt),yt=-1):ut=!0,Pt(dt,kt-St))):(vt.sortIndex=Ct,o(b,vt),at||it||(at=!0,Ut(ft))),vt},e.unstable_shouldYield=Lt,e.unstable_wrapCallback=function(vt){var bt=tt;return function(){var kt=tt;tt=bt;try{return vt.apply(this,arguments)}finally{tt=kt}}}})(scheduler_production_min);scheduler.exports=scheduler_production_min;var schedulerExports=scheduler.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const toKebabCase=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),createLucideIcon=(e,o)=>{const s=reactExports.forwardRef(({color:a="currentColor",size:c=24,strokeWidth:h=2,absoluteStrokeWidth:d,className:g="",children:b,..._},$)=>reactExports.createElement("svg",{ref:$,...defaultAttributes,width:c,height:c,stroke:a,strokeWidth:d?Number(h)*24/Number(c):h,className:["lucide",`lucide-${toKebabCase(e)}`,g].join(" "),..._},[...o.map(([et,tt])=>reactExports.createElement(et,tt)),...Array.isArray(b)?b:[b]]));return s.displayName=`${e}`,s};/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`,o-1))}function readPlainScalar(e,o,s){var a,c,h,d,g,b,_,$,et=e.kind,tt=e.result,it;if(it=e.input.charCodeAt(e.position),is_WS_OR_EOL(it)||is_FLOW_INDICATOR(it)||it===35||it===38||it===42||it===33||it===124||it===62||it===39||it===34||it===37||it===64||it===96||(it===63||it===45)&&(c=e.input.charCodeAt(e.position+1),is_WS_OR_EOL(c)||s&&is_FLOW_INDICATOR(c)))return!1;for(e.kind="scalar",e.result="",h=d=e.position,g=!1;it!==0;){if(it===58){if(c=e.input.charCodeAt(e.position+1),is_WS_OR_EOL(c)||s&&is_FLOW_INDICATOR(c))break}else if(it===35){if(a=e.input.charCodeAt(e.position-1),is_WS_OR_EOL(a))break}else{if(e.position===e.lineStart&&testDocumentSeparator(e)||s&&is_FLOW_INDICATOR(it))break;if(is_EOL(it))if(b=e.line,_=e.lineStart,$=e.lineIndent,skipSeparationSpace(e,!1,-1),e.lineIndent>=o){g=!0,it=e.input.charCodeAt(e.position);continue}else{e.position=d,e.line=b,e.lineStart=_,e.lineIndent=$;break}}g&&(captureSegment(e,h,d,!1),writeFoldedLines(e,e.line-b),h=d=e.position,g=!1),is_WHITE_SPACE(it)||(d=e.position+1),it=e.input.charCodeAt(++e.position)}return captureSegment(e,h,d,!1),e.result?!0:(e.kind=et,e.result=tt,!1)}function readSingleQuotedScalar(e,o){var s,a,c;if(s=e.input.charCodeAt(e.position),s!==39)return!1;for(e.kind="scalar",e.result="",e.position++,a=c=e.position;(s=e.input.charCodeAt(e.position))!==0;)if(s===39)if(captureSegment(e,a,e.position,!0),s=e.input.charCodeAt(++e.position),s===39)a=e.position,e.position++,c=e.position;else return!0;else is_EOL(s)?(captureSegment(e,a,c,!0),writeFoldedLines(e,skipSeparationSpace(e,!1,o)),a=c=e.position):e.position===e.lineStart&&testDocumentSeparator(e)?throwError(e,"unexpected end of the document within a single quoted scalar"):(e.position++,c=e.position);throwError(e,"unexpected end of the stream within a single quoted scalar")}function readDoubleQuotedScalar(e,o){var s,a,c,h,d,g;if(g=e.input.charCodeAt(e.position),g!==34)return!1;for(e.kind="scalar",e.result="",e.position++,s=a=e.position;(g=e.input.charCodeAt(e.position))!==0;){if(g===34)return captureSegment(e,s,e.position,!0),e.position++,!0;if(g===92){if(captureSegment(e,s,e.position,!0),g=e.input.charCodeAt(++e.position),is_EOL(g))skipSeparationSpace(e,!1,o);else if(g<256&&simpleEscapeCheck[g])e.result+=simpleEscapeMap[g],e.position++;else if((d=escapedHexLen(g))>0){for(c=d,h=0;c>0;c--)g=e.input.charCodeAt(++e.position),(d=fromHexCode(g))>=0?h=(h<<4)+d:throwError(e,"expected hexadecimal character");e.result+=charFromCodepoint(h),e.position++}else throwError(e,"unknown escape sequence");s=a=e.position}else is_EOL(g)?(captureSegment(e,s,a,!0),writeFoldedLines(e,skipSeparationSpace(e,!1,o)),s=a=e.position):e.position===e.lineStart&&testDocumentSeparator(e)?throwError(e,"unexpected end of the document within a double quoted scalar"):(e.position++,a=e.position)}throwError(e,"unexpected end of the stream within a double quoted scalar")}function readFlowCollection(e,o){var s=!0,a,c=e.tag,h,d=e.anchor,g,b,_,$,et,tt={},it,at,ut,ct;if(ct=e.input.charCodeAt(e.position),ct===91)b=93,et=!1,h=[];else if(ct===123)b=125,et=!0,h={};else return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=h),ct=e.input.charCodeAt(++e.position);ct!==0;){if(skipSeparationSpace(e,!0,o),ct=e.input.charCodeAt(e.position),ct===b)return e.position++,e.tag=c,e.anchor=d,e.kind=et?"mapping":"sequence",e.result=h,!0;s||throwError(e,"missed comma between flow collection entries"),at=it=ut=null,_=$=!1,ct===63&&(g=e.input.charCodeAt(e.position+1),is_WS_OR_EOL(g)&&(_=$=!0,e.position++,skipSeparationSpace(e,!0,o))),a=e.line,composeNode(e,o,CONTEXT_FLOW_IN,!1,!0),at=e.tag,it=e.result,skipSeparationSpace(e,!0,o),ct=e.input.charCodeAt(e.position),($||e.line===a)&&ct===58&&(_=!0,ct=e.input.charCodeAt(++e.position),skipSeparationSpace(e,!0,o),composeNode(e,o,CONTEXT_FLOW_IN,!1,!0),ut=e.result),et?storeMappingPair(e,h,tt,at,it,ut):_?h.push(storeMappingPair(e,null,tt,at,it,ut)):h.push(it),skipSeparationSpace(e,!0,o),ct=e.input.charCodeAt(e.position),ct===44?(s=!0,ct=e.input.charCodeAt(++e.position)):s=!1}throwError(e,"unexpected end of the stream within a flow collection")}function readBlockScalar(e,o){var s,a,c=CHOMPING_CLIP,h=!1,d=!1,g=o,b=0,_=!1,$,et;if(et=e.input.charCodeAt(e.position),et===124)a=!1;else if(et===62)a=!0;else return!1;for(e.kind="scalar",e.result="";et!==0;)if(et=e.input.charCodeAt(++e.position),et===43||et===45)CHOMPING_CLIP===c?c=et===43?CHOMPING_KEEP:CHOMPING_STRIP:throwError(e,"repeat of a chomping mode identifier");else if(($=fromDecimalCode(et))>=0)$===0?throwError(e,"bad explicit indentation width of a block scalar; it cannot be less than one"):d?throwError(e,"repeat of an indentation width identifier"):(g=o+$-1,d=!0);else break;if(is_WHITE_SPACE(et)){do et=e.input.charCodeAt(++e.position);while(is_WHITE_SPACE(et));if(et===35)do et=e.input.charCodeAt(++e.position);while(!is_EOL(et)&&et!==0)}for(;et!==0;){for(readLineBreak(e),e.lineIndent=0,et=e.input.charCodeAt(e.position);(!d||e.lineIndent<g)&&et===32;)e.lineIndent++,et=e.input.charCodeAt(++e.position);if(!d&&e.lineIndent>g&&(g=e.lineIndent),is_EOL(et)){b++;continue}if(e.lineIndent<g){c===CHOMPING_KEEP?e.result+=common$1.repeat(`
`,h?1+b:b):c===CHOMPING_CLIP&&h&&(e.result+=`
`);break}for(a?is_WHITE_SPACE(et)?(_=!0,e.result+=common$1.repeat(`
`,h?1+b:b)):_?(_=!1,e.result+=common$1.repeat(`
`,b+1)):b===0?h&&(e.result+=" "):e.result+=common$1.repeat(`
`,b):e.result+=common$1.repeat(`
`,h?1+b:b),h=!0,d=!0,b=0,s=e.position;!is_EOL(et)&&et!==0;)et=e.input.charCodeAt(++e.position);captureSegment(e,s,e.position,!1)}return!0}function readBlockSequence(e,o){var s,a=e.tag,c=e.anchor,h=[],d,g=!1,b;for(e.anchor!==null&&(e.anchorMap[e.anchor]=h),b=e.input.charCodeAt(e.position);b!==0&&!(b!==45||(d=e.input.charCodeAt(e.position+1),!is_WS_OR_EOL(d)));){if(g=!0,e.position++,skipSeparationSpace(e,!0,-1)&&e.lineIndent<=o){h.push(null),b=e.input.charCodeAt(e.position);continue}if(s=e.line,composeNode(e,o,CONTEXT_BLOCK_IN,!1,!0),h.push(e.result),skipSeparationSpace(e,!0,-1),b=e.input.charCodeAt(e.position),(e.line===s||e.lineIndent>o)&&b!==0)throwError(e,"bad indentation of a sequence entry");else if(e.lineIndent<o)break}return g?(e.tag=a,e.anchor=c,e.kind="sequence",e.result=h,!0):!1}function readBlockMapping(e,o,s){var a,c,h,d,g=e.tag,b=e.anchor,_={},$={},et=null,tt=null,it=null,at=!1,ut=!1,ct;for(e.anchor!==null&&(e.anchorMap[e.anchor]=_),ct=e.input.charCodeAt(e.position);ct!==0;){if(a=e.input.charCodeAt(e.position+1),h=e.line,d=e.position,(ct===63||ct===58)&&is_WS_OR_EOL(a))ct===63?(at&&(storeMappingPair(e,_,$,et,tt,null),et=tt=it=null),ut=!0,at=!0,c=!0):at?(at=!1,c=!0):throwError(e,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),e.position+=1,ct=a;else if(composeNode(e,s,CONTEXT_FLOW_OUT,!1,!0))if(e.line===h){for(ct=e.input.charCodeAt(e.position);is_WHITE_SPACE(ct);)ct=e.input.charCodeAt(++e.position);if(ct===58)ct=e.input.charCodeAt(++e.position),is_WS_OR_EOL(ct)||throwError(e,"a whitespace character is expected after the key-value separator within a block mapping"),at&&(storeMappingPair(e,_,$,et,tt,null),et=tt=it=null),ut=!0,at=!1,c=!1,et=e.tag,tt=e.result;else if(ut)throwError(e,"can not read an implicit mapping pair; a colon is missed");else return e.tag=g,e.anchor=b,!0}else if(ut)throwError(e,"can not read a block mapping entry; a multiline key may not be an implicit key");else return e.tag=g,e.anchor=b,!0;else break;if((e.line===h||e.lineIndent>o)&&(composeNode(e,o,CONTEXT_BLOCK_OUT,!0,c)&&(at?tt=e.result:it=e.result),at||(storeMappingPair(e,_,$,et,tt,it,h,d),et=tt=it=null),skipSeparationSpace(e,!0,-1),ct=e.input.charCodeAt(e.position)),e.lineIndent>o&&ct!==0)throwError(e,"bad indentation of a mapping entry");else if(e.lineIndent<o)break}return at&&storeMappingPair(e,_,$,et,tt,null),ut&&(e.tag=g,e.anchor=b,e.kind="mapping",e.result=_),ut}function readTagProperty(e){var o,s=!1,a=!1,c,h,d;if(d=e.input.charCodeAt(e.position),d!==33)return!1;if(e.tag!==null&&throwError(e,"duplication of a tag property"),d=e.input.charCodeAt(++e.position),d===60?(s=!0,d=e.input.charCodeAt(++e.position)):d===33?(a=!0,c="!!",d=e.input.charCodeAt(++e.position)):c="!",o=e.position,s){do d=e.input.charCodeAt(++e.position);while(d!==0&&d!==62);e.position<e.length?(h=e.input.slice(o,e.position),d=e.input.charCodeAt(++e.position)):throwError(e,"unexpected end of the stream within a verbatim tag")}else{for(;d!==0&&!is_WS_OR_EOL(d);)d===33&&(a?throwError(e,"tag suffix cannot contain exclamation marks"):(c=e.input.slice(o-1,e.position+1),PATTERN_TAG_HANDLE.test(c)||throwError(e,"named tag handle cannot contain such characters"),a=!0,o=e.position+1)),d=e.input.charCodeAt(++e.position);h=e.input.slice(o,e.position),PATTERN_FLOW_INDICATORS.test(h)&&throwError(e,"tag suffix cannot contain flow indicator characters")}return h&&!PATTERN_TAG_URI.test(h)&&throwError(e,"tag name cannot contain such characters: "+h),s?e.tag=h:_hasOwnProperty$1.call(e.tagMap,c)?e.tag=e.tagMap[c]+h:c==="!"?e.tag="!"+h:c==="!!"?e.tag="tag:yaml.org,2002:"+h:throwError(e,'undeclared tag handle "'+c+'"'),!0}function readAnchorProperty(e){var o,s;if(s=e.input.charCodeAt(e.position),s!==38)return!1;for(e.anchor!==null&&throwError(e,"duplication of an anchor property"),s=e.input.charCodeAt(++e.position),o=e.position;s!==0&&!is_WS_OR_EOL(s)&&!is_FLOW_INDICATOR(s);)s=e.input.charCodeAt(++e.position);return e.position===o&&throwError(e,"name of an anchor node must contain at least one character"),e.anchor=e.input.slice(o,e.position),!0}function readAlias(e){var o,s,a;if(a=e.input.charCodeAt(e.position),a!==42)return!1;for(a=e.input.charCodeAt(++e.position),o=e.position;a!==0&&!is_WS_OR_EOL(a)&&!is_FLOW_INDICATOR(a);)a=e.input.charCodeAt(++e.position);return e.position===o&&throwError(e,"name of an alias node must contain at least one character"),s=e.input.slice(o,e.position),_hasOwnProperty$1.call(e.anchorMap,s)||throwError(e,'unidentified alias "'+s+'"'),e.result=e.anchorMap[s],skipSeparationSpace(e,!0,-1),!0}function composeNode(e,o,s,a,c){var h,d,g,b=1,_=!1,$=!1,et,tt,it,at,ut;if(e.listener!==null&&e.listener("open",e),e.tag=null,e.anchor=null,e.kind=null,e.result=null,h=d=g=CONTEXT_BLOCK_OUT===s||CONTEXT_BLOCK_IN===s,a&&skipSeparationSpace(e,!0,-1)&&(_=!0,e.lineIndent>o?b=1:e.lineIndent===o?b=0:e.lineIndent<o&&(b=-1)),b===1)for(;readTagProperty(e)||readAnchorProperty(e);)skipSeparationSpace(e,!0,-1)?(_=!0,g=h,e.lineIndent>o?b=1:e.lineIndent===o?b=0:e.lineIndent<o&&(b=-1)):g=!1;if(g&&(g=_||c),(b===1||CONTEXT_BLOCK_OUT===s)&&(CONTEXT_FLOW_IN===s||CONTEXT_FLOW_OUT===s?at=o:at=o+1,ut=e.position-e.lineStart,b===1?g&&(readBlockSequence(e,ut)||readBlockMapping(e,ut,at))||readFlowCollection(e,at)?$=!0:(d&&readBlockScalar(e,at)||readSingleQuotedScalar(e,at)||readDoubleQuotedScalar(e,at)?$=!0:readAlias(e)?($=!0,(e.tag!==null||e.anchor!==null)&&throwError(e,"alias node should not have any properties")):readPlainScalar(e,at,CONTEXT_FLOW_IN===s)&&($=!0,e.tag===null&&(e.tag="?")),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):b===0&&($=g&&readBlockSequence(e,ut))),e.tag!==null&&e.tag!=="!")if(e.tag==="?"){for(e.result!==null&&e.kind!=="scalar"&&throwError(e,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+e.kind+'"'),et=0,tt=e.implicitTypes.length;et<tt;et+=1)if(it=e.implicitTypes[et],it.resolve(e.result)){e.result=it.construct(e.result),e.tag=it.tag,e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);break}}else _hasOwnProperty$1.call(e.typeMap[e.kind||"fallback"],e.tag)?(it=e.typeMap[e.kind||"fallback"][e.tag],e.result!==null&&it.kind!==e.kind&&throwError(e,"unacceptable node kind for !<"+e.tag+'> tag; it should be "'+it.kind+'", not "'+e.kind+'"'),it.resolve(e.result)?(e.result=it.construct(e.result),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):throwError(e,"cannot resolve a node with !<"+e.tag+"> explicit tag")):throwError(e,"unknown tag !<"+e.tag+">");return e.listener!==null&&e.listener("close",e),e.tag!==null||e.anchor!==null||$}function readDocument(e){var o=e.position,s,a,c,h=!1,d;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap={},e.anchorMap={};(d=e.input.charCodeAt(e.position))!==0&&(skipSeparationSpace(e,!0,-1),d=e.input.charCodeAt(e.position),!(e.lineIndent>0||d!==37));){for(h=!0,d=e.input.charCodeAt(++e.position),s=e.position;d!==0&&!is_WS_OR_EOL(d);)d=e.input.charCodeAt(++e.position);for(a=e.input.slice(s,e.position),c=[],a.length<1&&throwError(e,"directive name must not be less than one character in length");d!==0;){for(;is_WHITE_SPACE(d);)d=e.input.charCodeAt(++e.position);if(d===35){do d=e.input.charCodeAt(++e.position);while(d!==0&&!is_EOL(d));break}if(is_EOL(d))break;for(s=e.position;d!==0&&!is_WS_OR_EOL(d);)d=e.input.charCodeAt(++e.position);c.push(e.input.slice(s,e.position))}d!==0&&readLineBreak(e),_hasOwnProperty$1.call(directiveHandlers,a)?directiveHandlers[a](e,a,c):throwWarning(e,'unknown document directive "'+a+'"')}if(skipSeparationSpace(e,!0,-1),e.lineIndent===0&&e.input.charCodeAt(e.position)===45&&e.input.charCodeAt(e.position+1)===45&&e.input.charCodeAt(e.position+2)===45?(e.position+=3,skipSeparationSpace(e,!0,-1)):h&&throwError(e,"directives end mark is expected"),composeNode(e,e.lineIndent-1,CONTEXT_BLOCK_OUT,!1,!0),skipSeparationSpace(e,!0,-1),e.checkLineBreaks&&PATTERN_NON_ASCII_LINE_BREAKS.test(e.input.slice(o,e.position))&&throwWarning(e,"non-ASCII line breaks are interpreted as content"),e.documents.push(e.result),e.position===e.lineStart&&testDocumentSeparator(e)){e.input.charCodeAt(e.position)===46&&(e.position+=3,skipSeparationSpace(e,!0,-1));return}if(e.position<e.length-1)throwError(e,"end of the stream or a document separator is expected");else return}function loadDocuments(e,o){e=String(e),o=o||{},e.length!==0&&(e.charCodeAt(e.length-1)!==10&&e.charCodeAt(e.length-1)!==13&&(e+=`
...
`),$=_.replace(this.rules.other.blockquoteSetextReplace,`
    $1`).replace(this.rules.other.blockquoteSetextReplace2,"");a=a?`${a}
${_}`:_,c=c?`${c}
${$}`:$;const et=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens($,h,!0),this.lexer.state.top=et,s.length===0)break;const tt=h.at(-1);if((tt==null?void 0:tt.type)==="code")break;if((tt==null?void 0:tt.type)==="blockquote"){const it=tt,at=it.raw+`
`+s.join(`
`),ut=this.blockquote(at);h[h.length-1]=ut,a=a.substring(0,a.length-it.raw.length)+ut.raw,c=c.substring(0,c.length-it.text.length)+ut.text;break}else if((tt==null?void 0:tt.type)==="list"){const it=tt,at=it.raw+`
`+s.join(`
`),ut=this.list(at);h[h.length-1]=ut,a=a.substring(0,a.length-tt.raw.length)+ut.raw,c=c.substring(0,c.length-it.raw.length)+ut.raw,s=at.substring(h.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:a,tokens:h,text:c}}}list(e){let o=this.rules.block.list.exec(e);if(o){let s=o[1].trim();const a=s.length>1,c={type:"list",raw:"",ordered:a,start:a?+s.slice(0,-1):"",loose:!1,items:[]};s=a?`\\d{1,9}\\${s.slice(-1)}`:`\\${s}`,this.options.pedantic&&(s=a?s:"[*+-]");const h=this.rules.other.listItemRegex(s);let d=!1;for(;e;){let b=!1,_="",$="";if(!(o=h.exec(e))||this.rules.block.hr.test(e))break;_=o[0],e=e.substring(_.length);let et=o[2].split(`
`,1)[0].replace(this.rules.other.listReplaceTabs,rt=>" ".repeat(3*rt.length)),tt=e.split(`
`,1)[0],it=!et.trim(),at=0;if(this.options.pedantic?(at=2,$=et.trimStart()):it?at=o[1].length+1:(at=o[2].search(this.rules.other.nonSpaceChar),at=at>4?1:at,$=et.slice(at),at+=o[1].length),it&&this.rules.other.blankLine.test(tt)&&(_+=tt+`
`,e=e.substring(tt.length+1),b=!0),!b){const rt=this.rules.other.nextBulletRegex(at),ot=this.rules.other.hrRegex(at),lt=this.rules.other.fencesBeginRegex(at),dt=this.rules.other.headingBeginRegex(at),ft=this.rules.other.htmlBeginRegex(at);for(;e;){const gt=e.split(`
`,1)[0];let wt;if(tt=gt,this.options.pedantic?(tt=tt.replace(this.rules.other.listReplaceNesting,"  "),wt=tt):wt=tt.replace(this.rules.other.tabCharGlobal,"    "),lt.test(tt)||dt.test(tt)||ft.test(tt)||rt.test(tt)||ot.test(tt))break;if(wt.search(this.rules.other.nonSpaceChar)>=at||!tt.trim())$+=`
`+wt.slice(at);else{if(it||et.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||lt.test(et)||dt.test(et)||ot.test(et))break;$+=`
`+tt}!it&&!tt.trim()&&(it=!0),_+=gt+`
`,e=e.substring(gt.length+1),et=wt.slice(at)}}c.loose||(d?c.loose=!0:this.rules.other.doubleBlankLine.test(_)&&(d=!0));let ut=null,ct;this.options.gfm&&(ut=this.rules.other.listIsTask.exec($),ut&&(ct=ut[0]!=="[ ] ",$=$.replace(this.rules.other.listReplaceTask,""))),c.items.push({type:"list_item",raw:_,task:!!ut,checked:ct,loose:!1,text:$,tokens:[]}),c.raw+=_}const g=c.items.at(-1);if(g)g.raw=g.raw.trimEnd(),g.text=g.text.trimEnd();else return;c.raw=c.raw.trimEnd();for(let b=0;b<c.items.length;b++)if(this.lexer.state.top=!1,c.items[b].tokens=this.lexer.blockTokens(c.items[b].text,[]),!c.loose){const _=c.items[b].tokens.filter(et=>et.type==="space"),$=_.length>0&&_.some(et=>this.rules.other.anyLine.test(et.raw));c.loose=$}if(c.loose)for(let b=0;b<c.items.length;b++)c.items[b].loose=!0;return c}}html(e){const o=this.rules.block.html.exec(e);if(o)return{type:"html",block:!0,raw:o[0],pre:o[1]==="pre"||o[1]==="script"||o[1]==="style",text:o[0]}}def(e){const o=this.rules.block.def.exec(e);if(o){const s=o[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),a=o[2]?o[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",c=o[3]?o[3].substring(1,o[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):o[3];return{type:"def",tag:s,raw:o[0],href:a,title:c}}}table(e){var d;const o=this.rules.block.table.exec(e);if(!o||!this.rules.other.tableDelimiter.test(o[2]))return;const s=splitCells(o[1]),a=o[2].replace(this.rules.other.tableAlignChars,"").split("|"),c=(d=o[3])!=null&&d.trim()?o[3].replace(this.rules.other.tableRowBlankLine,"").split(`
...
`+g.raw,_.text+=`
`+g.raw,this.inlineQueue.at(-1).src=_.text):this.tokens.links[g.tag]||(this.tokens.links[g.tag]={href:g.href,title:g.title});continue}if(g=this.tokenizer.table(o)){o=o.substring(g.raw.length),s.push(g);continue}if(g=this.tokenizer.lheading(o)){o=o.substring(g.raw.length),s.push(g);continue}let b=o;if((d=this.options.extensions)!=null&&d.startBlock){let _=1/0;const $=o.slice(1);let et;this.options.extensions.startBlock.forEach(tt=>{et=tt.call({lexer:this},$),typeof et=="number"&&et>=0&&(_=Math.min(_,et))}),_<1/0&&_>=0&&(b=o.substring(0,_+1))}if(this.state.top&&(g=this.tokenizer.paragraph(b))){const _=s.at(-1);a&&(_==null?void 0:_.type)==="paragraph"?(_.raw+=`
`+g.raw,_.text+=`
...
`+g.raw,_.text+=`
`+g.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=_.text):s.push(g);continue}if(o){const _="Infinite loop on byte: "+o.charCodeAt(0);if(this.options.silent){console.error(_);break}else throw new Error(_)}}return this.state.top=!0,s}inline(o,s=[]){return this.inlineQueue.push({src:o,tokens:s}),s}inlineTokens(o,s=[]){var g,b,_;let a=o,c=null;if(this.tokens.links){const $=Object.keys(this.tokens.links);if($.length>0)for(;(c=this.tokenizer.rules.inline.reflinkSearch.exec(a))!=null;)$.includes(c[0].slice(c[0].lastIndexOf("[")+1,-1))&&(a=a.slice(0,c.index)+"["+"a".repeat(c[0].length-2)+"]"+a.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(c=this.tokenizer.rules.inline.anyPunctuation.exec(a))!=null;)a=a.slice(0,c.index)+"++"+a.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);for(;(c=this.tokenizer.rules.inline.blockSkip.exec(a))!=null;)a=a.slice(0,c.index)+"["+"a".repeat(c[0].length-2)+"]"+a.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);let h=!1,d="";for(;o;){h||(d=""),h=!1;let $;if((b=(g=this.options.extensions)==null?void 0:g.inline)!=null&&b.some(tt=>($=tt.call({lexer:this},o,s))?(o=o.substring($.raw.length),s.push($),!0):!1))continue;if($=this.tokenizer.escape(o)){o=o.substring($.raw.length),s.push($);continue}if($=this.tokenizer.tag(o)){o=o.substring($.raw.length),s.push($);continue}if($=this.tokenizer.link(o)){o=o.substring($.raw.length),s.push($);continue}if($=this.tokenizer.reflink(o,this.tokens.links)){o=o.substring($.raw.length);const tt=s.at(-1);$.type==="text"&&(tt==null?void 0:tt.type)==="text"?(tt.raw+=$.raw,tt.text+=$.text):s.push($);continue}if($=this.tokenizer.emStrong(o,a,d)){o=o.substring($.raw.length),s.push($);continue}if($=this.tokenizer.codespan(o)){o=o.substring($.raw.length),s.push($);continue}if($=this.tokenizer.br(o)){o=o.substring($.raw.length),s.push($);continue}if($=this.tokenizer.del(o)){o=o.substring($.raw.length),s.push($);continue}if($=this.tokenizer.autolink(o)){o=o.substring($.raw.length),s.push($);continue}if(!this.state.inLink&&($=this.tokenizer.url(o))){o=o.substring($.raw.length),s.push($);continue}let et=o;if((_=this.options.extensions)!=null&&_.startInline){let tt=1/0;const it=o.slice(1);let at;this.options.extensions.startInline.forEach(ut=>{at=ut.call({lexer:this},it),typeof at=="number"&&at>=0&&(tt=Math.min(tt,at))}),tt<1/0&&tt>=0&&(et=o.substring(0,tt+1))}if($=this.tokenizer.inlineText(et)){o=o.substring($.raw.length),$.raw.slice(-1)!=="_"&&(d=$.raw.slice(-1)),h=!0;const tt=s.at(-1);(tt==null?void 0:tt.type)==="text"?(tt.raw+=$.raw,tt.text+=$.text):s.push($);continue}if(o){const tt="Infinite loop on byte: "+o.charCodeAt(0);if(this.options.silent){console.error(tt);break}else throw new Error(tt)}}return s}},_Renderer=class{constructor(e){At(this,"options");At(this,"parser");this.options=e||_defaults}space(e){return""}code({text:e,lang:o,escaped:s}){var h;const a=(h=(o||"").match(other.notSpaceStart))==null?void 0:h[0],c=e.replace(other.endingNewline,"")+`
